...
class SAdminController extends Controller {
    ...
    public function actionEmail($file) {
        ...
        $body = $this->renderPartial('/zEmails/' . $file, array(
            'param1' => $param1,
            'param2' => $param2,
            'param3' => $param3,
            'param4' => $param4,
        ...
        EmailComponent::sendEmail("peter@agungpodomoro.com", $subject, $body, 'non-ssl');

        Yii::app()->user->setFlash('success', '<strong>Well done!</strong> <strong>' . $param1 . '</strong>.<br/> 
				 
				');

        $this->render('empty', array('body' => $body));
    }
    ...
    public function actionMongo() {
        ...
        $this->render('empty', array('body' => $storedfile));
    }
