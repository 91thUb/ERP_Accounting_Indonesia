 ...
 */
class albumPhoto2 extends CWidget {
                            ...
                            <li class="span<?php echo $this->span ?>">
                                <div class="thumbnail">
                                    ...
                                    if (is_file(Yii::app()->basePath . "/../shareimages/photo2/thumbs/" . $filename[0] . ".jpg")) {
                                        $photo = Yii::app()->request->baseUrl . "/shareimages/photo2/thumbs/" . $filename[0] . ".jpg";
                                    }
                                    else
                                        $photo = Yii::app()->request->baseUrl . "/shareimages/photo2/" . $filename[0] . ".jpg";
                                    ...
                                    <p><?php
                                        if ($this->showDescription)
                                            echo (isset($xml)) ? CHtml::tag('p',array('style'=>'font-size:12px'),peterFunc::shorten_string(strip_tags($xml->children()->description), $this->descLimit)) : "";
                                        ?>
                                    </p>
                                </div>
                            </li>
