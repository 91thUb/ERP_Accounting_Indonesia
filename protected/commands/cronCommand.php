        ...
        foreach ($lists as $list) {
            ...
            if ($model['userid'] != null) {
                ...
                $sql4 = "
					...
					Your new Balance Leave has just added today. Your new balance is: " . $new_balance . " day(s) valid from today up to next year.
					Based on company rules, if you still have positive balance on previous period, you can apply extended leave, then approved by your superior
					and it will added into this current balance. 
					Thank You.. <br/><br/>
					APHRIS',
