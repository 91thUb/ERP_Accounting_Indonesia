...
<ul>
    <li>Bagian kiri berisi data memo, yang terdiri dari
        <ul>
    ...
    <li><p>Kolom kanan berisi
        <ul>
            ...
            <li>Update, link ke halaman update memo</li>
            <li>Print, link untuk download memo</li>
...
<img src="/images/man/yIom_view.jpg">