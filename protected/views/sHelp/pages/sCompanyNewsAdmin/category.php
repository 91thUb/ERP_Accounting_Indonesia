    ...
    <li>Bagian kiri atas berisi daftar kategori berita holding, yang terdiri dari kolom
        ...
        <ul>
            <li>Klik <img src="/images/man/pencil.jpg"> maka APHRIS akan 
                ke menampilkan form ubah kategori berita seperti berikut <img src="/images/man/sCompanyNewsUnit_category_update.jpg"></li>
            <li>Ubah data di form tersebut, lalu klik Save</li>
        </ul><br>Untuk menghapus data kategori berita tertentu, lakukan langkah berikut
        <ul>
            ...
            <li>klik button OK untuk menghapus data kategori, atau buutton Cancel jika batal menghapus data kategori</li>
        </ul>
    </li>
