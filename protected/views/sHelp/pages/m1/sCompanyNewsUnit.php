...
<ul>
    <li>Bagian kiri atas berisi daftar berita unit bisnis, yang terdiri dari kolom
        ...
        <ul>
            <li>Klik <img src="/images/man/pencil.jpg"> maka APHRIS akan 
                ke halaman ubah Business Unit News seperti berikut <img src="/images/man/m1_sCompanyNewsUnit_update.jpg"></li>
            <li>Ubah data di form tersebut, lalu klik Save</li>
        </ul><br>Untuk menghapus data berita tertentu, lakukan langkah berikut
        <ul>
            ...
            <li>klik button OK untuk menghapus data berita unit bisnis, atau buutton Cancel jika batal menghapus data berita unit bisnis</li>
        </ul>
    </li>
    <li>Bagian kiri bawah berisi form upload foto kegiatan unit bisnis, yang terdiri dari
        <ul>
            ...
            <li>Upload Files, untuk memilih file yang akan diupload klik Browse, sistem akan menampilkan window untuk memilih file yang akan diupload <img src="/images/man/upload_foto.jpg">. Pilih file yang akan diupload, lalu klik Open.</li>
            <li>Upload, setelah memilih file, klik Upload untuk mengupload foto, maka foto unit bisnis akan ditampilkan di halaman login di bagian foto unit bisnis</li>
        </ul>
    </li>
