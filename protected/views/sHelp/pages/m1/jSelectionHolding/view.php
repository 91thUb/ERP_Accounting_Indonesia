    ...
    <li><p>Kolom kiri berisi 
        <ul>
            ...
            <li>Form registrasi peserta seleksi baru
                <ul>
                    <li>Applicant Name, nama pelamar. Ketikkan sebagian nama pelamar, maka di bawah input akan tampil daftar pelamar yang namanya mirip dengan teks yang diketik 
                        <img src="/images/man/autocomplete-name.jpg">, lalu pilih salah satu pelamar yang muncul di daftar sebagai pelamar yang akan mengikuti tahap seleksi</li>
                ...
                <ul>
                    ...
                    <li>klik button OK untuk menghapus data peserta seleksi, atau button Cancel jika batal menghapus data peserta seleksi</li>
                </ul>
            </li>
    ...
    <li><p>Kolom kanan berisi
        <ul>
            ...
            <li>Delete, link untuk menghapus jadwal seleksi. Untuk menghapus jadwal seleksi, lakukan langkah berikut
                <ul>
                    <li>klik icon <img src="/images/man/bin.jpg"> pada baris yang ingin dihapus. APHRIS akan meminta konfirmasi penghapusan data <img src="/images/man/konfirmasi_delete.jpg"></li>
                    <li>klik button OK untuk menghapus data jadwal seleksi, atau button Cancel jika batal menghapus data jadwal seleksi</li>
                </ul>
            </li>
        </ul>
    </li>
