    ...
    <li><p>Kolom kanan berisi detil data pelamar, yang terdiri dari	
        <ul>
            ...
            <li>Tab Candidate Profile, tab ini berisi
                ...
                Untuk menghapus salah satu baris pada tabel experience, education, family, dan non formal education, lakukan langkah berikut</p>
                <ul>
            ...
            <li>Tab Create New/Experience, berisi form untuk menambah pengalaman kerja pelamar. Form ini terdiri dari 
                <ul>
                    ...
                    <li>Year Length, Month Length, lama bekerja. Misal bekerja selama 2.5 tahun, maka Year Length diisi 2, dan Month Length diisi 6</li>
            ...
            <li>Tab Create New/Education, berisi form untuk menambah data pendidikan formal pelamar. Form ini terdiri dari 
                <ul>
            ...
            <li>Tab Create New/Non Formal Education, berisi form untuk menambah data pendidikan non formal pelamar. Form ini terdiri dari 
                <ul>
            ...
            <li>Form New Process, berada di bagian bawah data pelamar, berupa form untuk menambah proses seleksi baru untuk pelamar tersebut. Form ini terdiri dari
                <ul>
