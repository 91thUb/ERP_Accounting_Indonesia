...
<ul>
    <li>Kolom kiri terdapat 3 tab yaitu, yaitu
        <ul>
            <li>Tab Upcoming Events, berisi daftar jadwal training yang akan diadakan untuk topik tersebut. Tabel ini memiliki kolom
                <ul>
            ...
            <li>Tab Past Events, berisi daftar jadwal training yang sudah diadakan untuk topik tersebut. Tabel ini memiliki kolom
                <ul>
                    <li>Schedule Date: tanggal diadakannya training, berupa link ke detil informasi jadwal training</li>
                    <li>Trainer Name: nama trainer</li>
                    <li>Location: lokasi tempat diadakannya training</li>
                    ...
                    <li>Actual Mandays: lama training, dengan satuan man day. 
                        Untuk mengubah mandays, klik mandays yang ingin diubah maka APHRIS akan menampilkan form untuk mengubah mandays seperti berikut
                        <img src="/images/man/m1_iLearningHolding_view_actual_mandays.jpg">
                        Misal lama training adalah 4 jam (dari 8 jam kerja), maka mandays yang diisikan adalah 0.5</li>
                </ul>
        ...
        <p>Untuk menambah data jadwal training baru, 
            isi form tambah jadwal training, yang berada pada bagian bawah tab lalu klik Create. Form tambah jadwal training terdiri dari</p>
        <ul>
            <li>Schedule Date: tanggal diadakannya training, berupa link ke detil informasi jadwal training</li>
            <li>Trainer Name: nama trainer</li>
            <li>Location: lokasi tempat diadakannya training</li>
        ...
        <p>Untuk mengubah jadwal training (hanya dapat dilakukan untuk jadwal yang ada di tab Upcoming Events), lakukan langkah berikut:</p>
        <ul>
            <li>Klik <img src="/images/man/pencil.jpg"> maka APHRIS akan menampilkan form seperti berikut <img src="/images/man/m1_iLearningHolding_view_edit.jpg"></li>
        ...
        <ul>
            ...
            <li>klik button OK untuk menghapus data jadwal training, atau button Cancel jika batal menghapus data jadwal training</li>
        </ul>
    ...
    <li>Kolom kanan berisi
        <ul>
            ...
            <li>Delete, link untuk menghapus topik training. Untuk menghapus topik training, lakukan langkah berikut</p>
                <ul>
                    <li>klik link Delete. APHRIS akan meminta konfirmasi penghapusan data <img src="/images/man/konfirmasi_delete.jpg"></li>
                    <li>klik button OK untuk menghapus data topik training yang sedang dilihat, atau button Cancel jika batal menghapus data topik training</li>
                </ul>
            </li>
