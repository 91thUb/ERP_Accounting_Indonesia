    ...
    <li>Kolom kiri berisi 
        <ul>
            ...
            <li>Form tambah peserta baru. 
                ...
                <ul>
                    <li>Ketikkkan sebagian nama peserta yang ingin ditambahkan, maka APHRIS akan menampilkan daftar pegawai yang memiliki nama mirip dengan yang diketikkan</li>
                    <li>Pilih nama pegawai yang menjadi peserta training, dan klik Create. Nama pegawai akan tampil pada daftar peserta di bagian bawah form tambah</li>
                </ul>
                <img src="/images/man/m1_iLearningHolding_viewDetail_new_participant.jpg">
            </li>
            <li>Tab Detail, berisi button Confirm All untuk mengkonfirmasikan kepesertaan semua pendaftar dan daftar peserta dari keseluruhan anak perusahaan
                ...
                <ul>
                    ...
                    <li>Status: status kepesertaan. Status kepesertaan dapat diubah dengan klik status tersebut, maka sistem akan menampilkan window untuk mengubah status seperti berikut
                        <img src="/images/man/m1_iLearningHolding_viewDetail_confirm.jpg">. Pilih status kepesertaan lalu klik tanda centang. Untuk menutup window tersebut, klik tanda silang.
                    </li>
                    <li>Day1: presensi hari pertama. Status presensi dapat diubah dengan klik presensi tersebut, maka sistem akan menampilkan window untuk mengubah presensi seperti berikut
                        <img src="/images/man/m1_iLearningHolding_viewDetail_presence.jpg">. Pilih presensi, lalu klik tanda centang. Untuk menutup window tersebut, klik tanda silang.
                    </li>
            ...
            <li>Tab Feedback, berisi komentar dan feedback dari peserta
                ...
                <ul>
                    <li>No: nomor urut</li>
                    <li>Employee Name: nama pegawai peserta training, beserta nama anak perusahaan, departemen dan job levelnya</li>
            ...
            <li>Tab Photo, berisi daftar dan form upload foto kegiatan training
                ...
                <ul>
                    ...
                    <li>Pilih file yang akan diupload, lalu klik Open. Sistem akan memperlihatkan persentase upload file
                        <img src="/images/man/m1_iLearningHolding_viewDetail_photo_upload.jpg">. </li>
                </ul>
            </li>
        </ul>
    </li>
