...
<p>
    Halaman ini menampilkan form untuk mengubah data pegawai. Untuk mengubah data pegawai, isikan data pegawai di form tersebut, lalu klik tombol Save. Form data pegawai terdiri dari beberapa bagian yaitu
<ul>
