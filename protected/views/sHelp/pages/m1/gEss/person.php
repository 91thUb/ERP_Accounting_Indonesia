...
<ul>
    ...
    <li>Bagian bawah berisi data lanjutan pegawai. Data lanjutan terdiri dari beberapa tab. Angka yang berada di samping judul tab, menyatakan jumlah data yang ada di tab tersebut. Misal, pada tab Education terdapat angka 1, berarti ada 1 baris data pendidikan pada tab tersebut. Ada beberapa tab data pegawai, yaitu
        <ul>
            <li>Tab Detil memiliki tampilan seperti berikut <br><img src="/images/man/m1_gEss_person_detail.jpg">. Tab ini berisi data detil yang terdiri dari
                <ul>
            ...
            <li>Tab Career - Experience - Status memiliki tampilan seperti berikut <br><img src="/images/man/m1_gEss_person_career_experience_status.jpg">. Tab ini berisi daftar 
                <ul>
            ...
            <li>Tab Education memiliki tampilan seperti berikut <br><img src="/images/man/m1_gEss_person_education.jpg">. Tab ini berisi daftar 
                <ul>
            ...
            <li>Tab Training memiliki tampilan seperti berikut <br><img src="/images/man/m1_gEss_person_training.jpg">. Tab ini berisi daftar 
                <ul>
            ...
            <li>Tab Family memiliki tampilan seperti berikut <br><img src="/images/man/m1_gEss_person_family.jpg">. Tab ini berisi daftar anggota keluarga, memiliki data
                <ul>
            ...
            <li>Tab Other memiliki tampilan seperti berikut <br><img src="/images/man/m1_gEss_person_other.jpg">. Tab ini berisi daftar dokumen-dokumen seperti KTP, KK, SIM, Paspor, memiliki data
                <ul>
