...
<ul>
    <li>Daftar, memiliki dua tab yaitu
        <ul>
            <li>Daftar absensi bulan berjalan. Untuk melihat daftar absen bulan lain, gunakan link Previous Month dan Next Month.</li>
            <li>Detil pegawai</li>
        </ul>   
    </li>
...
<ul>
    <li>Isi form input, yang terdiri dari:
        <ul>
            ...
            <li>Real Pattern, </li>
            <li>In, jam masuk kerja. Ketik dengan format dd-mm-yyyy hh:mm (misal 30-03-2014 11:53), atau gunakan date time picker <img src="/images/man/select_date_time.jpg"></li>
...
<ul>
    <li>Klik icon <img src="/images/man/pencil.jpg">, APHRIS akan menampilkan <img src="/images/man/m1_gAttendance_view_update.jpg"</li>
