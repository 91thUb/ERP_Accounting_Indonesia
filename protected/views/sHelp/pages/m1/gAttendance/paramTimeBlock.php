...
<ul>
    <li>Daftar blok jam kerja. Untuk mengupdate blok jam kerja, klik icon <img src="/images/man/pencil.jpg">. Untuk menghapus blok jam kerja, klik icon <img src="/images/man/bin.jpg">.</li>
...
<ul>
    <li>Isi form input, yang terdiri dari:
        <ul>
            ...
            <li>In, jam masuk kerja. Ketik dengan format hh:mm (misal 20:30), atau gunakan slider <img src="/images/man/select_time.jpg"></li>
...
<ul>
    <li>Klik icon <img src="/images/man/pencil.jpg">, APHRIS akan menampilkan <img src="/images/man/m1_gAttendance_paramTimeBlock_update.jpg"</li>
...
<ul>
    <li>klik icon <img src="/images/man/bin.jpg">, APHRIS akan meminta konfirmasi penghapusan data <img src="/images/man/konfirmasi_delete.jpg"></li>
    <li>klik button OK untuk menghapus data blok jam kerja, atau button Cancel jika batal menghapus data blok jam kerja</li>
</ul>