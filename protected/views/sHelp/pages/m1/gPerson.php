            ...
            <li>Operation berisi 
                <ul>
                    ...
                    <li>List of Uncomplete Data, link ke
                        daftar pegawai yang datanya belum lengkap</li>
                    <li>Birthday of the Month, link ke
                        daftar pegawai yang berulang tahun pada bulan berjalan</li>
                    <li>Probation/Contract, link ke
                        daftar pegawai yang statusnya Probation atau Contract</li>
                    <li>Employee In/Out, link ke daftar
                        pegawai yang baru masuk atau keluar</li>
                    <li>Black List, link ke dafftar
                        pegawai yang di-black-list</li>
                    <li>Help, link ke manual halaman
                        Personel Administration</li>
                </ul>
            </li>
            <li>Recent Update berisi daftar nama
                pegawai yang datanya baru diperbarui</li>
            <li>Recent Add berisi daftar nama
                pegawai yang datanya baru ditambahkan</li>
            <li>Related berisi daftar pegawai
                yang memiliki nama mirip dengan pegawai yang sedang dilihat datanya</li>
        </ul>
    </li>
</ul>
<BR>
