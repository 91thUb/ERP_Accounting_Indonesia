...
<ul>
    <li>Bagian kiri berisi form tambah berita unit bisnis, yang terdiri dari
        <ul>
            ...
            <li>Publish Date, tanggal terbit artikel.  Jika input ini di klik maka akan keluar tampilan seperti <img src="/images/man/select_date_time.jpg">. Pilih tanggal untuk menetapkan tanggal seleksi, dan gunakan slider hour dan minute untuk menetapkan waktu seleksi, lalu klik Done</li>
            <li>Expire Date, tanggal artikel selesai diterbitkan/ditampilkan</li>
            <li>Content, isi artikel. Pada input content terdapat tool sederhana untuk mem format isi artikel. Formatting yang disediakan adalah
                <ul>
