...
<p>Halaman ini digunakan untuk mencari pegawai dalam perusahaan tempat Anda bekerja. Parameter pencarian dimasukkan pada 3 tab yaitu</p>
<ul>
    <li>Tab Field List, digunakan untuk memilih kolom yang ditampilkan pada hasil pencarian. <img src="/images/man/m1_gBiPerson_fieldlist.jpg">
        <ul>
    ...
    <li>Tab Filter, digunakan untuk menyaring data pegawai yang ditampilkan pada hasil pencarian. <img src="/images/man/m1_gBiPerson_filter.jpg">
    ...
    <li>Tab Limit, digunakan untuk membatasi jumlah baris yang akan ditampilkan pada hasil pencarian.  <img src="/images/man/m1_gBiPerson_limit.jpg"> Untuk memasukkan data pegawai yang sudah resign ke hasil pencarian, centang checkbox Include Resign Employee</li>
</ul>
