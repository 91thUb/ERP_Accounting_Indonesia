    ...
    <li>Campaign, promosi lowongan. Bagian ini terdiri dari
        <ul>
            ...
            <li>Untuk menambah data campaign baru, lakukan langkah berikut:
                <ul>
                    <li>Klik button Show/Hide New Campaign, maka APHRIS akan menampilkan form input campaign seperti berikut <img src="/images/man/m1_hVacancy_view_show_hide_new_campaign.jpg"></li>
            ...
            <li>Untuk mengubah data campaign tertentu, lakukan langkah berikut:
                <ul>
                    <li>Klik <img src="/images/man/pencil.jpg"> maka APHRIS akan menampilkan form seperti berikut <img src="/images/man/m1_hVacancy_view_update_campaign.jpg"></li>
            ...
            <li>Untuk menghapus data campaign tertentu, lakukan langkah berikut
                <ul>
                    ...
                    <li>klik button OK untuk menghapus data campaign, atau button Cancel jika batal menghapus data campaign</li>
                </ul>
            </li>
        </ul>

    </li>
    <li>Detail, untuk menampilkan atau menyembunyikan detil lowongan, klik link Show/Hide Detail. Detil yang ditampilkan adalah syarat-syarat lowongan tersebut, dan ditampilkan di atas tab-tab pelamar <img src="/images/man/m1_hVacancy_view_show_hide_detail.jpg"></li>
</li>
<li>Bagian bawah berisi data pelamar yang dikelompokkan dalam 9 kelompok yaitu
    ...
    Disamping nama tab terdapat angka yang menunjukkan jumlah pelamar yang ada dalam tab kelompok tersebut. <img src="/images/man/m1_hVacancy_view_applicant.jpg">. Masing-masing tab tersebut daftar pelamar yang ada dalam kelompok tersebut, dengan detil
    <ul>
        <li>Foto</li>
        <li>Waktu Melamar</li>
        <li>Nama</li>
        ...
        <li>Tombol Action, berada di samping foto. Untuk memindahkan pelamar ke kelompok pelamar lain, klik tombol Action, pilih kelompok pelamar lain </li>  
    </ul>
</li>
</ul>