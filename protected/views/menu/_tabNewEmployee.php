<div class="row">
    <div class="span4">
        <div style="border-bottom:solid;border-width:1px;border-color:#D5D5D5;padding:0;margin:10px 0;">
            <ul class="nav nav-list">
                <li class="nav-header"><i class="fa fa-user fa-fw"></i><?php echo Yii::t('basic', 'Welcome New Employees') ?>
                </li>
            </ul>
        </div>
    ...
    <div class="span4">
        <div style="border-bottom:solid;border-width:1px;border-color:#D5D5D5;padding:0;margin:10px 0;">
            <ul class="nav nav-list">
                <li class="nav-header"><i class="fa fa-user fa-fw"></i><?php echo Yii::t('basic', 'Employee Career Updated') ?>
                </li>
            </ul>
        </div>
