...
class Mailbox extends CActiveRecord {
    ...
    public static function getMessageCount() {
        $unread = "";
        $unread = (self::newMsgs(Yii::app()->user->id) != 0) ? CHtml::tag("span", array('style' => 'font-size:inherit', 'class' => 'badge badge-info'), self::newMsgs(Yii::app()->user->id)) : "";
    ...
    public function delete($userid = 0) {
        ...
        if ($this->initiator_id == $userid) {
            ...
            if ((!$this->initiator_del && $this->initiator_del > Yii::app()->controller->module->recyclePeriod) || !Yii::app()->controller->module->trashbox) {
                // permanently delete
