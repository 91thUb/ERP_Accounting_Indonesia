...
class aBudgetDetail extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('parent_id, periode_date, prequest_id, created_date, updated_date', 'numerical', 'integerOnly' => true),
            ...
            array('id, parent_id, input_date, periode_date, no_ref, prequest_id, tdebt, tcredit, balance, remark, created_date, created_by, updated_date, updated_by', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'get_saldo' => array(self::STAT, 'aBudgetDetail', 'parent_id', 'select' => 'balance', 'order' => 'id DESC'),
        );
    }
