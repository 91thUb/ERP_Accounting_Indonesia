...
/**
 * This is the model class for table "u_customer".
 *
 * The followings are the available columns in table 'u_customer':
 * @property integer $id
 ...
 */
class uCustomer extends BaseModel {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return uCustomer the static model class
     */
