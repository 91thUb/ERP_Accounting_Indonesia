...
class UCashbankController extends Controller {
    ...
    public function actionUpdate($id) {
        ...
        if ($modelHeader->state_id == 3 or $modelHeader->state_id == 4) {
            ...
            $this->redirect(array('/m2/uCashbank/view', 'id' => $modelHeader->id));
        }
    ...
    public function actionDelete($id) {
        ...
        if ($model->state_id == 3 or $model->state_id == 4) {
            ...
            $this->redirect(array('/m2/uCashbank/view', 'id' => $model->id));
        }
    ...
    public function actionCreateIncome() {
        ...
        if (isset($_POST['account_no_id'])) {
            ...
            if ($model->validate()) {
                ...
                Yii::app()->user->setFlash("success", "Journal created succesfully... View Jurnal: " . CHtml::link($modelHeader->system_ref, Yii::app()->createUrl("/m2/uCashbank/view", array("id" => $modelHeader->id))));
                $this->redirect(array('/m2/uCashbank'));
            }
        }
