...
if ($isAdmin) {
    ...
    $adminheader = '<div class="admin" style="float:right; font-size:smaller;width:250px">' .
            CHtml::link('New forum', array('/forum/forum/create', 'parentid' => $forum->id), array('style' => 'display:inline')) . ' | ' .
            CHtml::link('Edit', array('/forum/forum/update', 'id' => $forum->id), array('style' => 'display:inline')) . ' | ' .
            CHtml::ajaxLink('Delete category', array('/forum/forum/delete', 'id' => $forum->id), array('type' => 'POST', 'success' => 'function(){document.location.reload(true);}'), array('confirm' => $deleteConfirm, 'style' => 'display:inline')) .
            '</div>';
