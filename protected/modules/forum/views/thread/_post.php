...
<div class="post">
    <div class="header">
        <?php echo Yii::app()->controller->module->format_date($data->created, 'long'); ?> by <?php echo CHtml::link(CHtml::encode($data->author->username), Yii::app()->createUrl('/sUser/viewAuthenticated', array('id' => $data->author_id))); ?>
        ...
        if ($isAdmin) {
            ...
            CHtml::ajaxLink('Delete post', array('/forum/admin/deletepost', 'id' => $data->id), array('type' => 'POST', 'success' => 'function(){document.location.reload(true);}'), array('confirm' => $deleteConfirm, 'id' => 'post' . $data->id)
            ) .
            '</div>';
        }
        ?>
