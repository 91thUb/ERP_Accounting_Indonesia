...
if (isset($forum))
    $this->widget('zii.widgets.CBreadcrumbs', array(
        'links' => array_merge(
                $forum->getBreadcrumbs(true), array('New thread')
        ),
    ));
else
    $this->widget('zii.widgets.CBreadcrumbs', array(
        'links' => array_merge(
                $thread->getBreadcrumbs(true), array('New reply')
        ),
    ));
?>
...
<div class="form" style="margin:20px;">
    ...
    <?php if (isset($forum)): ?>
        <div class="row">
            ...
            <?php echo $form->textField($model, 'subject', array('class' => 'span8')); ?>
    ...
    <div class="row">
        ...
        <?php echo $form->textArea($model, 'content', array('class' => 'span8', 'rows' => 4)); ?>
