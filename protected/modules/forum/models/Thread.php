...
class Thread extends CActiveRecord {
    ...
    public function renderSubjectCell() {
        ...
        $authorlink = CHtml::link(CHtml::encode($firstpost->author->username), Yii::app()->createUrl('sUser/viewAuthenticated', array('id' => $firstpost->author_id)));
