...
foreach (array_keys($this->module->controllerMap) as $controllerName)
    $content .= ' ' . CHtml::link(Yii::t('email', ucfirst($controllerName)), array($controllerName . '/index'), array('class' => 'btn btn-large btn-primary'));
//$this->beginWidget('ext.bootstrap.widgets.TbHeroUnit', array(
