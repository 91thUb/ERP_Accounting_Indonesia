...
/**
 * This is the model class for table "g_talent_core_competency".
 *
 * The followings are the available columns in table 'g_talent_core_competency':
 * @property integer $id
 ...
 */
class gTalentCoreCompetency extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'g_talent_core_competency';
    }
    ...
    public function rules() {
        ...
        return array(
            array('talent_template_id,company_id, year, period_id, superior_score, personal_score, 
			superior2_score, personal2_score, level_id,level2_id', 'numerical', 'integerOnly' => true),
    ...
    public function relations() {
        ...
        return array(
            ...
            'level2' => array(self::BELONGS_TO, 'gParamLevel', 'level2_id'),
