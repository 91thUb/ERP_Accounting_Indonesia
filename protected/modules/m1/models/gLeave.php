...
class gLeave extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            array('input_date, start_date, end_date, number_of_day,leave_reason', 'required'),
            array('parent_id, parent_name,', 'required', 'on' => 'create'),
            array('work_date', 'required', 'on' => 'createess'),
            array('parent_id, year_leave, number_of_day, balance, approved_id, activation_expire', 'numerical', 'integerOnly' => true),
            array('start_date, end_date, input_date, work_date', 'date', 'format' => 'dd-MM-yyyy'),
            array('leave_reason', 'length', 'max' => 300),
            array('activation_code', 'length', 'max' => 100),
            ...
            array('id, parent_id, input_date, year_leave, start_date, end_date, number_of_day, work_date, leave_reason, balance, replacement, remark, approved_id', 'safe', 'on' => 'search'),
            array('start_date',
    ...
    public function attributeLabels() {
        return array(
            ...
            'number_of_day' => 'Number Of Working Days',
            'work_date' => 'Work Date',
            'leave_reason' => 'Reason',
            'balance' => 'Balance',
