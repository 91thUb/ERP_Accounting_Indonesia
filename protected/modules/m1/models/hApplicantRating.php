...
class hApplicantRating extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('parent_id, user_id, rating, created_date, created_by', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, parent_id, user_id, rating, comment, created_date, created_by', 'safe', 'on' => 'search'),
        );
    }
