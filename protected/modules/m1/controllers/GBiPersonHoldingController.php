...
class GBiPersonHoldingController extends Controller {
    ...
    public function actionIndex() {
        ...
        if (!isset($_POST['field'])) {
            $model->field[] = "id";
            $model->field[] = "employee_name";
            $model->field[] = "company";
            $model->field[] = "department";
            $model->field[] = "level";
            $model->field[] = "job_title";
            $model->field[] = "employee_status";
            $model->field[] = "join_date";
            $model->fieldfilter[] = 'id';
        }
        ...
        $this->render('/gBiPerson/index2', array(
            'model' => $model,
            'dataProvider' => $dataProvider,
            'field' => $fieldresult,
            'production' => $production,
