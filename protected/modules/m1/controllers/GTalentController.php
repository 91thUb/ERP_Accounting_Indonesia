...
class GTalentController extends Controller {
    ...
    public function actionView($id, $year = 0) {
        ...
        $modelPerformanceR = $this->newPerformanceR($id, $year);
        $modelPotential = $this->newPotential($id, $year);
        $modelTargetSetting = $this->newTargetSetting($id, $year);
        $modelCoreCompetency = $this->newCoreCompetency($id, $year);
        $modelLeadershipCompetency = $this->newLeadershipCompetency($id, $year);
    ...
    public function newPerformanceP($id, $year = 0) {
        ...
        if (isset($_POST['fPerformance'])) {
            ...
            $model->parent_id = $id;
            if ($model->save())
                $this->redirect(array('view', 'id' => $id, 'year' => $year,));
        }
     ...
     * If creation is successful, the browser will be redirected to the 'view' page.
     */
    public function newPerformanceR($id, $year = 0) {
    ...
    public function newTargetSetting($id, $year = 0) {
        ...
        if (isset($_POST['gTalentTargetSetting'])) {
            ...
            $model->parent_id = $id;
            if ($model->save())
                $this->redirect(array('view', 'id' => $id, 'year' => $year, 'tab' => 'Work Result'));
        }

        return $model;
    }

    public function newCoreCompetency($id, $year = 0) {
        ...
        if (isset($_POST['gTalentCoreCompetency'])) {
            ...
            $model->parent_id = $id;
            if ($model->save())
                $this->redirect(array('view', 'id' => $id, 'year' => $year, 'tab' => 'Core Competency'));
        }

        return $model;
    }

    public function newLeadershipCompetency($id, $year = 0) {
    ...
    public function actionUpdateTargetSetting($id, $year = 0) {
        ...
        EQuickDlgs::render('_formTargetSetting', array('model' => $model, 'year' => $year));
    }
