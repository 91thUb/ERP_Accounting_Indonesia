...
<div class="row">
    <div class="span6">
        ...
        <?php
        echo $form->html5EditorRow($model, 'vacancy_desc', array(
            'htmlOptions' => array('class' => 'span4', 'rows' => 5, 'height' => '300')));
        ?>

        <?php
        echo $form->html5EditorRow($model, 'skill_required', array(
            'htmlOptions' => array('class' => 'span4', 'rows' => 5, 'height' => '300')));
        ?>
        ...
        <?php
        echo $form->dropDownListRow($model, 'for_level', array(
            'Pelaksana' => 'Pelaksana',
