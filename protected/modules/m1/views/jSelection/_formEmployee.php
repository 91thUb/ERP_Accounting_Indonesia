...
Yii::app()->clientScript->registerScript('datepicker', "
		...
		$( \"#" . CHtml::activeId($model, 'applicant_name') . "\" ).autocomplete({
			'minLength' : 2,
			'source': ' " . Yii::app()->createUrl('/m1/jSelection/employeeAutoCompletePhoto') . "',
...
<?php echo $form->textFieldRow($model, 'applicant_name', array('hint' => 'Select from your current employee', 'class' => 'span4')); ?>
