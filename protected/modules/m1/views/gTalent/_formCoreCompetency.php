...
<?php echo $form->dropDownListRow($model, 'talent_template_id', gParamCompetency::coreDropDown(), array('class' => 'span5', 'maxlength' => 50));
?>


<?php //echo $form->textFieldRow($model,'superior_score',array('class'=>'span1'));  ?>
...
<div class="form-actions">
    ...
    $this->widget('bootstrap.widgets.TbButton', array(
        'type' => 'primary',
        'url' => Yii::app()->createUrl('/m1/gTalent/generateCoreCompetency', array('id' => $id, 'year' => $year)),
        'label' => 'Generate All',
    ));
    ?>
