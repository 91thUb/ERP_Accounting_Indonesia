...
<?php echo $form->dropDownListRow($model, 'talent_template_id', gParamCompetency::workResultDropDown(), array('class' => 'span5', 'maxlength' => 50));
?>
...
<div class="form-actions">
    ...
    $this->widget('bootstrap.widgets.TbButton', array(
        'type' => 'primary',
        'url' => Yii::app()->createUrl('/m1/gTalent/generateWorkResult', array('id' => $id, 'year' => $year)),
        'label' => 'Generate All',
    ));
    ?>
