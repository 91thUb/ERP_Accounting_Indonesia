!function(e) {
    ...
    var t = function(e, i, n) {
        ...
        if (s.onerror = i, s.onload = function() {
            ...
            o = a = t.createObjectURL(e), s._type = e.type;
        else {
            if ("string" != typeof e)
                return!1;
    ...
    t.isInstanceOf = function(e, t) {
        ...
        if (window.FileReader) {
            ...
            if (n.onload = n.onerror = t, i = i || "readAsDataURL", n[i])
                return n[i](e), n
        }
        return!1
    ...
    e.extend(e.fn.modal.Constructor.prototype, {initLinks: function() {
            ...
            for (i = n.index - n.preloadRange; o > i; i += 1)
                t = this.$links[i], t && i !== n.index && e("<img>").prop("src", this.getUrl(t))
        }, loadImage: function() {
